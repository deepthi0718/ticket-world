document.addEventListener("DOMContentLoaded", function() {
    ...
    return params.get('Standups') || "No standups Selected";
}

// Display the movie name
const StandupsName = getMovieNameFromURL();
document.getElementById('Stanup-name').textContent = `🎞️ Standup: ${StandupsName}`;
    ...
    payNowBtn.addEventListener("click", function() {
        ...
        const seatPrices = selectedSeats.map(seat => seat.price);
            ...
            localStorage.setItem("standups", StandupsName)
